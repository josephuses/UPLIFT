...
\end{tikzpicture}
	...
	\end{itemize}
\Item Salyn has \textpeso20,000 in a savings account at the beginning of the year. She wants to have at least
\textpeso14,000 in her account by the end of the summer. She withdraws \textpeso500 every week for
...
\end{tikzpicture}
	...
	w&\le 12\; \text{weeks}
	\end{align*}
	Thus, Salyn has a maximum of 12 weeks to withdraw \textpeso500 weekly.
	\end{itemize}
\Item Owen wants to order USBs on the Internet. Each USB costs \textpeso250.00 and shipping for the entire
order is \textpeso200.00. Owen has at most \textpeso5,300 to spend.
	\begin{itemize}
	\item Write an inequality that represents Owen's situation.
	\item How many USB's can Owen order with her \textpeso5,300?

	\Solution: Let $u =$ number of USBs that Owen can buy
	
	
	\begin{tabular}{YYYYY}
	\Tikzmark{i1}{250$u$} &  \Tikzmark{i2}{$+$} & \Tikzmark{i3}{200} & \Tikzmark{i4}{$\le$} & \Tikzmark{i5}{5,300}\\
	& & & & \\
	& & & & \\
	& & & & \\
  & & & \Tikzmark{j4}{at most} & \\
